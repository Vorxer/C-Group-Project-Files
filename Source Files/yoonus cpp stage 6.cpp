...
int main()
{
	BankAccount orginal;
	BankAccount newacc;
	orginal.enterAccountData();
	newacc.enterAccountData();
	transaction trasnferfund;
	double transamount;
	cout << "amount to be transfered" << endl;
	cin >> transamount;
	trasnferfund.Transfer(orginal, newacc, transamount);
	cout << orginal.getBalance() << endl;
	cout << newacc.getBalance() << endl;
